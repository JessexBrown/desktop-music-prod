...
load-broken-parent-symlink, save-symlink, save-broken-symlink,
save-broken-parent-symlink,
...
and broken-symlink settings-file plus broken parent load/save rejection when
host-supported.
