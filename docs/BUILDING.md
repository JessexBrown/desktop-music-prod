...
temporary-manifest symlink cleanup tests when host-supported, manifest symlink
save rejection tests when host-supported, staged temporary-manifest open/commit
failure tests, Save As retry manifest/asset
