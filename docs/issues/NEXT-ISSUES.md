...
## 1. Add AppSession Load Package Path File Failure Coverage
...
## 2. Add Project Load Package Path File Settings Isolation Coverage
...
## 3. Add AppSession Load Package Path File Settings Isolation Coverage
...
## 4. Add Project Load Missing Manifest Settings Isolation Coverage
...
## 5. Add AppSession Load Missing Manifest Settings Isolation Coverage
