...
## 1. Add AppSession Save Broken Asset Folder Symlink Failure Coverage
...
## 2. Add App Settings Load Broken Parent Symlink Failure Coverage
...
## 3. Add App Settings Load Linked Parent Symlink Failure Coverage
...
## 4. Add Background Save As Broken Target Symlink Failure Coverage
...
## 5. Add Project Save Linked Later Asset Folder Symlink Coverage
