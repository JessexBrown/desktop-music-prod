...
## 2. Add Project Chooser Failure-State Smoke Coverage
...
## 3. Add Audio/MIDI Reset App Smoke Coverage
...
## 4. Add Linux JUCE App CI Prerequisite Note
...
## 5. Add Restore Manifest Reveal App Wiring
