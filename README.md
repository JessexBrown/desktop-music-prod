...
- Malformed or symlinked app settings, including broken settings links, fall
  back to defaults; core tests cover load/save symlink rejection, and a hidden
  smoke test verifies the Device Panel warning and recovery path that rewrites
  valid human-readable settings without touching projects.
