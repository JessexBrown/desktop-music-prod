...
- Project load rejects direct package symlinks, including broken links, linked
  ...
  and verifies project and AppSession direct package symlink failures, project
  broken direct package symlink failures, linked/broken package-parent
  failures, and manifest-link failures do not rewrite isolated app settings or
