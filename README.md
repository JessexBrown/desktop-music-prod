...
- Project package model that writes a human-readable `manifest.json` plus
  ...
  project and AppSession invalid loop-region schema failures,
...
- Project load rejects package paths occupied by files, direct package
  ...
  failures, project and AppSession package-path file failures, project and
  AppSession direct package symlink failures, including broken links, project
  linked/broken package-parent failures,
