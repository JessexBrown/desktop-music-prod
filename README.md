...
- Malformed or symlinked app settings fall back to defaults; core tests cover
  load/save symlink rejection, and a hidden smoke test verifies the Device Panel
