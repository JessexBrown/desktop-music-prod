...
- Malformed or symlinked app settings, including broken settings links, fall
  ...
  file and parent save rejection, and stale temporary symlink cleanup, including
  broken links, and a hidden smoke test verifies the Device Panel warning and
  recovery path that rewrites valid human-readable settings without touching
  projects.
