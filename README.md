...
- Project load rejects package paths occupied by files, direct package
  ...
  failures and verifies project and AppSession package-path file failures,
  project and AppSession direct package symlink failures, including broken
  links, project linked/broken package-parent failures,
